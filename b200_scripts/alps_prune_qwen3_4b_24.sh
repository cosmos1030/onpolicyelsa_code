...
# point at /NHNHOME persistent storage and Qwen/Qwen3-4B is pulled from the
# HF hub instead of the other server's local snapshot cache path).
# Usage: bash b200_scripts/alps_prune_qwen3_4b_24.sh
set -e
...
echo "=== ALPS Pruning Qwen3-4B 2:4 semi-structured (1xB200, local container run) ==="
echo "NODE=$(hostname)"
