...
#
# Usage: bash b200_scripts/alps_sft_ntpkd_opkd_qwen3_8b_24.sh [LR] [OPD_GEN_LEN] \
#          [LR_SCHEDULER] [DATA_PATH] [SEQLEN] [MASK_INTERVAL] [WANDB_PROJECT]
# e.g.: bash b200_scripts/alps_sft_ntpkd_opkd_qwen3_8b_24.sh 1e-4
set -e
...
SPARSITY=0.5
SPARSITY_TYPE=2:4
ALPS_MODEL="/NHNHOME/log-postech/doyoonkim/models/qwen3_8b_alps_s24"
SPARSITY_TAG="n24"
...
JOB_TAG="alpssft_8b_b200_${SPARSITY_TAG}"
...
echo "=== ALPS -> Sparse SFT NTP+KD+OPKD(0.33/0.33/0.33) Qwen3-8B ${SPARSITY_TAG} (2:4 semi-structured) lr=${LR} opd_gen_len=${OPD_GEN_LEN} seqlen=${SEQLEN} -- 1xB200 single-GPU, vLLM in-process ==="
