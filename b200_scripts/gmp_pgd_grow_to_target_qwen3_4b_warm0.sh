...
JOB_TAG="gmp_pgd_grow_4b_b200_warm0_s${SPARSITY_PCT}_lr${LR}_klb${KL_BUDGET}_pgdi${PGD_INTERVAL}"
...
$PYTHON main.py \
    ...
    --seed=42 \
    --run_name_suffix="pgd_grow2target_klbudget${KL_BUDGET}_lr${LR}_pgdi${PGD_INTERVAL}_${PRUNING_SCOPE}scope_b200_warm0"
