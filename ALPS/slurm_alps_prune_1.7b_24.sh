...
#SBATCH --output=/local-data/user-data/%u/alps_1.7b_24_%j/slurm_%j.out
#SBATCH --exclude=n3,n42,n46,n51,n54,n60,n77,n80,n91,n61,n64
exec 2>&1

# ALPS 2:4 semi-structured pruning + full eval for Qwen3-1.7B
# Companion to the unstructured s50 run (wandb cmcym5wn)
# Usage: sbatch slurm_alps_prune_1.7b_24.sh
...
SAVED_MODEL="${SAVE_BASE}/qwen3_1.7b_alps_s24"

LOCAL_JOB_BASE="/local-data/user-data/${USER}/alps_1.7b_24_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/alps_1.7b_24_${SLURM_JOB_ID}_debug"
...
echo "=== ALPS Pruning Qwen3-1.7B 2:4 semi-structured ==="
