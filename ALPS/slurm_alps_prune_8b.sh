...
# Usage: sbatch slurm_alps_prune_8b.sh <SPARSITY>

SPARSITY=${1:?"Usage: sbatch slurm_alps_prune_8b.sh <SPARSITY>"}
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/alps_8b_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/alps_8b_${SLURM_JOB_ID}_debug"
...
echo "=== ALPS Pruning Qwen3-8B s${SPARSITY_PCT}% ==="
