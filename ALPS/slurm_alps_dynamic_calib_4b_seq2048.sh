#!/bin/bash
#SBATCH --job-name=alps_4b_dyncalib_seq2048
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/alps_4b_dyncalib_seq2048_%j.out
exec 2>&1
...
SAVE="/home1/doyoonkim/projects/elsa/models/qwen3_4b_alps_dyncalib_seq2048_s${SPARSITY_PCT}pct"
OUT_LOG="/home1/doyoonkim/projects/ALPS/kldiag_out/dyncalib_seq2048_4b_s${SPARSITY_PCT}pct.jsonl"
...
$PYTHON qwen3_alps_dynamic_calib.py \
    ...
    --n_ot 102 --n_fw 26 \
    --refresh_ratio 0.25 \
    --gen_max_new_tokens 2048 --vllm_gpu_mem 0.4 --vllm_max_prompt_len 1024 \
    --rho 300.0 \
    --seed 42 \
    --save "$SAVE" \
    --out "$OUT_LOG" \
    --push_to_hub \
    --hub_model_id "cosmos1030/alps-dyncalib-seq2048-s${SPARSITY_PCT}pct"
