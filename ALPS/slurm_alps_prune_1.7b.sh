...
#SBATCH --output=/local-data/user-data/%u/alps_1.7b_%j/slurm_%j.out
#SBATCH --exclude=n3,n42,n46,n51,n52,n54,n55,n58,n60,n76,n77,n80,n91,n61,n64
exec 2>&1

# ALPS pruning + full eval for Qwen3-1.7B
# Usage: sbatch slurm_alps_prune_1.7b.sh <SPARSITY>

SPARSITY=${1:?"Usage: sbatch slurm_alps_prune_1.7b.sh <SPARSITY>"}
...
SAVED_MODEL="${SAVE_BASE}/qwen3_1.7b_alps_s${SPARSITY_PCT}pct"

LOCAL_JOB_BASE="/local-data/user-data/${USER}/alps_1.7b_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/alps_1.7b_${SLURM_JOB_ID}_debug"
...
echo "=== ALPS Pruning Qwen3-1.7B s${SPARSITY_PCT}% ==="
...
$PYTHON qwen3_alps.py \
    ...
    --run_name "alps_s${SPARSITY_PCT}pct" \
    --gpu_util 0.9 \
    --tp_size 1 \
