...
#SBATCH --output=/local-data/user-data/%u/alps_8b_24_%j/slurm_%j.out
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/alps_8b_24_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/alps_8b_24_${SLURM_JOB_ID}_debug"
