#!/bin/bash
#SBATCH --job-name=alps_8b_24_rtx6000ada
...
#SBATCH --output=/local-data/user-data/%u/alps_8b_24_rtx6000ada_%j/slurm_%j.out
exec 2>&1

# ALPS 2:4 semi-structured pruning + full eval for Qwen3-8B
# Usage: sbatch slurm_alps_prune_8b_24.sh
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/alps_8b_24_rtx6000ada_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/alps_8b_24_rtx6000ada_${SLURM_JOB_ID}_debug"
...
echo "=== ALPS Pruning Qwen3-8B 2:4 semi-structured ==="
