#!/bin/bash
#SBATCH --job-name=sparsellm_1.7b_24
...
#SBATCH --output=/local-data/user-data/%u/sparsellm_1.7b_24_%j/slurm_%j.out
#SBATCH --exclude=n3,n42,n46,n51,n52,n54,n55,n58,n60,n76,n77,n80,n91,n61,n64
exec 2>&1

# SparseLLM 2:4 semi-structured pruning + full eval for Qwen3-1.7B
# Usage: sbatch slurm_sparsellm_prune_1.7b_24.sh
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/sparsellm_1.7b_24_${SLURM_JOB_ID}"
...
DEBUG_COPY_DIR="/home1/doyoonkim/projects/elsa/logs/sparsellm_1.7b_24_${SLURM_JOB_ID}_debug"
...
echo "=== SparseLLM Pruning Qwen3-1.7B 2:4 semi-structured ==="
