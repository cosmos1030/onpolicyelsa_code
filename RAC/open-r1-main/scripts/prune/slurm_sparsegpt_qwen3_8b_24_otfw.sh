#!/bin/bash
#SBATCH --job-name=sparsegpt_8b_24_otfw
...
#SBATCH --output=/home1/doyoonkim/projects/RAC/open-r1-main/logs_trace/sparsegpt_8b_24_%j.out
exec 2>&1

# Same as slurm_sparsegpt_qwen3_8b_otfw.sh but 2:4 semi-structured
# (--prune_N 2 --prune_M 4). grpo.py's save-path resolution appends an
# "N2_M4" tag automatically, so glob for the resulting directory.

MODEL_HASH="b968826d9c46dd6066d109eabc6255188de91218"
SAVE_DIR="/home1/doyoonkim/projects/RAC/open-r1-main/models"

PYTHON=/home1/doyoonkim/miniconda3/envs/rac/bin/python
LOCAL_JOB_BASE="/local-data/user-data/${USER}/sparsegpt_8b_24_${SLURM_JOB_ID}"
...
echo "=== SparseGPT Qwen3-8B 2:4 semi-structured (OT80/FW20 calib, 2048-trunc, same source as ALPS) ==="
