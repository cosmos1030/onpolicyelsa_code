...
DATASET_NAME=/home1/doyoonkim/projects/RAC/open-r1-main/math_trace/dataset_DeepSeek-R1-Distill-Qwen-1_trace_OpenR1-Math-220k
...
OUTPUT_DIR=/home1/doyoonkim/projects/RAC/open-r1-main/models/gkd_lr${LR}_lmb${LMBDA}_b${BETA}_t${TEMPERATURE}_tok${MAX_NEW_TOKENS}_bs${BS}_accum${ACCUM}_warm${WARMUP}_${LR_SCHEDULER}_opt${OPTIMIZER}
