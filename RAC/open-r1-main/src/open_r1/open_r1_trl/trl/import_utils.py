...
import transformers  # older version
if not hasattr(transformers, "is_comet_available"):
    from transformers.integrations import is_comet_available
    transformers.is_comet_available = is_comet_available
...
def is_rich_available() -> bool:
    """Return True if `rich` is importable, else False."""
    try:
