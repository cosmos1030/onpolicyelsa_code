#!/bin/bash
#SBATCH --job-name=elsa_plain_1.7b
...
#SBATCH --output=/local-data/user-data/%u/elsa_plain_1.7b_%j/slurm_%j.out
exec 2>&1
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_plain_1.7b_${SLURM_JOB_ID}"
...
DEBUG_LOG_COPY="/home1/doyoonkim/projects/elsa/logs/elsa_plain_1.7b_${SLURM_JOB_ID}_last.out"
