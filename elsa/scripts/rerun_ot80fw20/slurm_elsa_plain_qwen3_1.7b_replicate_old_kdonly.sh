...
# batch=8, 1xA100-80GB, lr_scheduler=linear/no-warmup, admm_lmda_schedule_mode
...
echo "=== ELSA plain+KD (replicate ef2zr9qy schedule) Qwen3-1.7B s${SPARSITY_PCT} (${SPARSITY_TYPE}), lmda=${LMDA}, kd=1.0/ntp=0.0, 1xA100-80GB (OT80/FW20) ==="
