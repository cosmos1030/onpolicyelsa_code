...
#SBATCH --exclude=n3,n42,n46,n51,n52,n54,n55,n58,n60,n76,n77,n80,n91,n61,n64,n19
#SBATCH --output=/local-data/user-data/%u/elsa_plain_4b_%j/slurm_%j.out
exec 2>&1

# Plain ELSA NTP-ADMM, Qwen3-4B, 4x RTX3090 FSDP, OT80/FW20 rerun
# (RERUN_PLAN_OT80FW20.md § Qwen3-4B ELSA NTP-ADMM plain table)
...
#
# Usage: sbatch slurm_elsa_plain_qwen3_4b.sh <SPARSITY> <LR> <LMDA> [SPARSITY_TYPE]
...
# e.g.: sbatch slurm_elsa_plain_qwen3_4b.sh 0.5 5e-5 1e-3
#       sbatch slurm_elsa_plain_qwen3_4b.sh 0.5 5e-5 5e-3 2:4

SPARSITY=${1:?"Usage: sbatch slurm_elsa_plain_qwen3_4b.sh <SPARSITY> <LR> <LMDA> [SPARSITY_TYPE]"}
LR=${2:?"Usage: sbatch slurm_elsa_plain_qwen3_4b.sh <SPARSITY> <LR> <LMDA> [SPARSITY_TYPE]"}
LMDA=${3:?"Usage: sbatch slurm_elsa_plain_qwen3_4b.sh <SPARSITY> <LR> <LMDA> [SPARSITY_TYPE]"}
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_plain_4b_${SLURM_JOB_ID}"
...
DEBUG_LOG_COPY="/home1/doyoonkim/projects/elsa/logs/elsa_plain_4b_${SLURM_JOB_ID}_last.out"
...
echo "=== Plain ELSA NTP-ADMM Qwen3-4B s${SPARSITY_PCT} (${SPARSITY_TYPE}), lr=${LR}, lmda=${LMDA}, 4xRTX3090 FSDP (OT80/FW20) ==="
