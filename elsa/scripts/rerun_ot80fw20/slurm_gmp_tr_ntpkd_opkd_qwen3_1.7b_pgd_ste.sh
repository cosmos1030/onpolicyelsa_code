#!/bin/bash
#SBATCH --job-name=tr_ntpkd_opkd_1.7b_pgd_ste
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/tr_ntpkd_opkd_1.7b_pgd_ste_%j.out
exec 2>&1
...
$PYTHON main.py \
    ...
    --run_name_suffix="${RUN_TAG:+${RUN_TAG}_}pgd_ste_lr${LR}_mi${MASK_INTERVAL}_kl${KL_THRESHOLD}_${PRUNING_SCOPE}scope_$(basename "$DATA_PATH" .jsonl)" \
    --seed=42
