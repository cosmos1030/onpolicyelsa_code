#!/bin/bash
#SBATCH --job-name=gmp_opkd_8k_4b
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/gmp_opkd_8k_4b_%j.out
exec 2>&1

# GMP NTP+KD+OPKD(dense) for Qwen3-4B, 8192 steps
# ntp_lambda=0.33, kd_lambda=0.33, onpolicy_kd_lambda=0.33
# Usage: sbatch slurm_gmp_ntp_kd_opkd_8192_qwen3_4b.sh <SPARSITY>

SPARSITY=${1:?"Usage: sbatch slurm_gmp_ntp_kd_opkd_8192_qwen3_4b.sh <SPARSITY>"}
...
echo "=== GMP NTP+KD+OPKD(dense) Qwen3-4B s${SPARSITY_PCT}% 8192 steps ==="
