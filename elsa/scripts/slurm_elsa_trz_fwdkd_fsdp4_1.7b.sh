#!/bin/bash
#SBATCH --job-name=elsa_trz_fsdp4
...
#SBATCH --output=/local-data/user-data/%u/elsa_trz_fsdp4_1.7b_%j/slurm_%j.out
exec 2>&1
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_trz_fsdp4_1.7b_${SLURM_JOB_ID}"
