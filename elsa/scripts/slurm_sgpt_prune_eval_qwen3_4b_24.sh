#!/bin/bash
#SBATCH --job-name=sgpt_qwen3_4b_24
...
# SparseGPT 2:4 semi-structured prune + full eval for Qwen3-4B → reasoning_qwen3_4b
# Usage: sbatch slurm_sgpt_prune_eval_qwen3_4b_24.sh [NSAMPLES=128]
...
SAVE_PATH="/home1/doyoonkim/projects/elsa/models/qwen3_4b_sgpt_s24_n${NSAMPLES}"
...
echo "=== SparseGPT Qwen3-4B (2:4 semi-structured) ==="
