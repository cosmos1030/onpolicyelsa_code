...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/elsa_trz_fwdkd_lasso1e2_lr1e4_3090_4x_%j.out
exec 2>&1
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_trz_fwdkd_lasso1e2_lr1e4_3090_4x_${SLURM_JOB_ID}"
