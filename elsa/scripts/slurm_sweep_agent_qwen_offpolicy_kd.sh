#!/bin/bash
#SBATCH --job-name=elsa_qwen_opkd
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/output_qwen/qwen0.6b_offpolicy_kd/%j.out
#SBATCH -t 3-00:00:00
...
mkdir -p /home1/doyoonkim/projects/elsa/output_qwen/qwen0.6b_offpolicy_kd
