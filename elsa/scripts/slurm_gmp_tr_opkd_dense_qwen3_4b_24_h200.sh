...
# Same recipe as wandb 7cho6yn0 (tr_opkd_kl001_s50, reasoning_qwen3_4b project)
# but sparsity_type=2:4 instead of unstructured, single target (no milestones).
# Usage: sbatch slurm_gmp_tr_opkd_dense_qwen3_4b_24_h200.sh <KL_THRESHOLD>

KL_THRESHOLD=${1:?"Usage: sbatch slurm_gmp_tr_opkd_dense_qwen3_4b_24_h200.sh <KL_THRESHOLD>"}
...
echo "=== TR-GMP NTP+KD+OPKD(Dense) Qwen3-4B 2:4 kl=${KL_THRESHOLD} (same recipe as 7cho6yn0) ==="
