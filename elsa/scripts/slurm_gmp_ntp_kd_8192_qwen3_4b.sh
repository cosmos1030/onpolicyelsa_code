#!/bin/bash
#SBATCH --job-name=gmp_ntp_kd_8k_4b
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/gmp_ntp_kd_8k_4b_%j.out
exec 2>&1

# GMP NTP+KD for Qwen3-4B, 8192 steps
# Usage: sbatch slurm_gmp_ntp_kd_8192_qwen3_4b.sh <SPARSITY>

SPARSITY=${1:?"Usage: sbatch slurm_gmp_ntp_kd_8192_qwen3_4b.sh <SPARSITY>"}
...
echo "=== GMP NTP+KD Qwen3-4B s${SPARSITY_PCT}% 8192 steps ==="
