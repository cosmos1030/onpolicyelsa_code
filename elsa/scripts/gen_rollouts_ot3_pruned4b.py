"""Generate rollouts from the pruned Qwen3-4B (TR-GMP dwup-only S70) on OpenThoughts3-1.2M
prompts, and push the resulting (prompt, completion) dataset to HuggingFace.

Usage: python gen_rollouts_ot3_pruned4b.py
"""
import os
import json
...
MODEL_PATH = "/home1/doyoonkim/projects/elsa/models/gmp_s70pct_lr0.0001_onpol_lmda0.33_20260723_070029"
N_PROMPTS = 20000
MAX_NEW_TOKENS = 2048
MAX_PROMPT_LEN = 1024
TEMPERATURE = 0.6
TOP_P = 0.95
OUT_REPO = "cosmos1030/qwen3-4b-gmp-tr-dwup-s70pct-ot3-rollouts"
OUT_JSONL = "/home1/doyoonkim/projects/elsa/data/ot3_rollouts_pruned4b_s70_20k.jsonl"
