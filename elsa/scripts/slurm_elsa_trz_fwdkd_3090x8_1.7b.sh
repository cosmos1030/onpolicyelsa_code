#!/bin/bash
#SBATCH --job-name=elsa_trz_3090x8
...
#SBATCH --output=/local-data/user-data/%u/elsa_trz_3090x8_1.7b_%j/slurm_%j.out
exec 2>&1
...
LASSO_LMDA=${LASSO_LMDA:-0}
ADMM_LMDA=${ADMM_LMDA:-0.05}

LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_trz_3090x8_1.7b_${SLURM_JOB_ID}"
