#!/bin/bash
#SBATCH --job-name=tr_kd_opkd_mag_layer_4b
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/tr_kd_opkd_mag_layer_4b_%j.out
exec 2>&1
...
echo "=== TR-GMP KD+OPKD(Dense) Qwen3-4B magnitude saliency layer-scope kl=${KL_THRESHOLD} (milestones: s50/s60/s70) ==="
