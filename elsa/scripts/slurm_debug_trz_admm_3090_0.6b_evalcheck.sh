#!/bin/bash
#SBATCH --job-name=dbg_trz_admm_0.6b_evalcheck
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/dbg_trz_admm_0.6b_evalcheck_%j.out
exec 2>&1
