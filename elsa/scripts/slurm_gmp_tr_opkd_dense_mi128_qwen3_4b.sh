#!/bin/bash
#SBATCH --job-name=tr_opkd_mi128_4b
...
#SBATCH --output=/home1/doyoonkim/projects/elsa/logs/tr_opkd_mi128_4b_%j.out
exec 2>&1
...
echo "=== TR-GMP NTP+KD+OPKD(Dense) Qwen3-4B kl=${KL_THRESHOLD} (milestones: s50/s60/s70) ==="
