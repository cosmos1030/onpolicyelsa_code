...
# ELSA sweep agent for Qwen3-1.7B — runs 1 config then eval_full.py
# Usage: for i in {1..9}; do sbatch slurm_elsa_sweep_agent_1.7b.sh <SWEEP_ID>; done

SWEEP_ARG=${1:?"Usage: sbatch slurm_elsa_sweep_agent_1.7b.sh <SWEEP_ID>"}
...
# ── Extract training wandb run ID to resume and log PPL into same run ─────────
# wandb prints: "wandb: 🚀 View run at https://wandb.ai/.../runs/RUNID"
