#!/bin/bash
#SBATCH --job-name=elsa_trz_lmda01_4g
...
#SBATCH --output=/local-data/user-data/%u/elsa_trz_lmda01_4g_%j/slurm_%j.out
exec 2>&1
...
LOCAL_JOB_BASE="/local-data/user-data/${USER}/elsa_trz_lmda01_4g_${SLURM_JOB_ID}"
