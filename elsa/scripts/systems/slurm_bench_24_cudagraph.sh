...
/home1/doyoonkim/miniconda3/envs/rac/bin/python scripts/systems/bench_24_cudagraph.py \
    --model /home1/doyoonkim/projects/elsa/models/scout_4b_2to4_best --out /home1/doyoonkim/projects/elsa/logs/systems/cg24_${SLURM_JOB_ID}.json
echo "=== EXIT: $? ==="; echo "##### END #####"
