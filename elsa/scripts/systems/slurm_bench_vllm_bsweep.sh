...
/home1/doyoonkim/miniconda3/envs/rac/bin/python scripts/systems/macko_vllm/bench_vllm_batch_sweep.py \
    --model "/home1/doyoonkim/.cache/huggingface/hub/models--Qwen--Qwen3-4B/snapshots/1cfa9a7208912126459214e8b04321603b3df60c" \
    --batches 1,4,8,32 --length 2048 \
    --out "$OUTDIR/vllm_bsweep_${SLURM_JOB_ID}.json"
EXIT_CODE=$?
