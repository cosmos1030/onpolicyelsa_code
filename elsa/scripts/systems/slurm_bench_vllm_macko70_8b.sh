#!/bin/bash
#SBATCH --job-name=vllm_macko70_8b
...
/home1/doyoonkim/miniconda3/envs/rac/bin/python scripts/systems/macko_vllm/bench_vllm_macko.py \
    ...
    --sparse /home1/doyoonkim/projects/elsa/models/qwen3_8b_selfgen_v3_alps_s70pct \
    --gpu_util 0.80 \
    --out "$OUTDIR/vllm_macko70_8b_${SLURM_JOB_ID}.json"
EXIT_CODE=$?
