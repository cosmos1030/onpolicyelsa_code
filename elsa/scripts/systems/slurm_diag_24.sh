...
/home1/doyoonkim/miniconda3/envs/rac/bin/python scripts/systems/diag_24_overhead.py \
    --model /home1/doyoonkim/projects/elsa/models/scout_4b_2to4_best
echo "=== EXIT: $? ==="; echo "##### END #####"
