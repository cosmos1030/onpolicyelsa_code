...
_FULL_BENCHMARKS = [
    ...
    ("aime25",  "lighteval|aime25|0",             38912, 38912,
     ["pass@k:k=1&n=1"]),
    ("gpqa",    "lighteval|gpqa:diamond|0",       32768, 32768,
     ["gpqa_pass@k:k=1", "pass@k:k=1&n=1", "acc_norm", "acc"]),
    ("ifeval",  "lighteval|ifeval|0",             32768, 32768,
...
_QUICK_BENCHMARKS = [
    ("math500", "lighteval|math_500|0",           8192, 8192,
     ["pass@k:k=1&n=1"]),
    ("gpqa",    "lighteval|gpqa:diamond|0",       8192, 8192,
     ["gpqa_pass@k:k=1", "pass@k:k=1&n=1", "acc_norm", "acc"]),
    ("ifeval",  "lighteval|ifeval|0",             8192, 8192,
     ["prompt_level_strict_acc"]),
    ("lcb",     "lighteval|lcb:codegeneration|0", 8192, 8192,
     ["codegen_pass@1:16", "pass@1"]),
    ("gsm8k",   "lighteval|gsm8k|0",              2048, 4096,
     ["extractive_match", "acc"]),
